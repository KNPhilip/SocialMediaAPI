...
public sealed class YTService(IConfiguration config) : IYTService
{
    private readonly IConfiguration _config = config;

    public async Task<ResponseDto<YouTubeResponseDto>> GetChannelVideos(
        string? pageToken = null, int maxResults = 10)
    {
